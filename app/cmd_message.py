...
prices = """
Вы можете купить кол-во запросов в телеграмм боте.

Тарифы:
- 100 запросов CHAT GPT 4o — 100 звёзд (~200р.)

Купить звёзды с российских карт можно через официального бота в телеграмм: @PremiumBot
"""
